...
p1 = ggplot(dataJC, aes(x = aa, y = bb))+
  ...
  geom_point(shape = 21, size = 3.8, fill = "#3A968B", position="jitter",alpha=0.8)+
  stat_smooth(method = "lm",formula = y ~ x, 
              size = 1.2, linetype = 1, alpha = 0.7, color = "#3E608D", fill = "#C5E0B4")+
...
p1
ggsave("LIA_2DLIA.pdf", p1, width = 6, height = 6, unit = "in", dpi = 900)
