# ============================================================================
# Scatter plot: 2D-LAR vs 2D-VAR with marginal histograms
# Output: PDF
# ============================================================================
...
p <- ggplot(data3, aes(x = cc, y = dd)) +
  ...
  annotate("text",
           x = min(cc) + 0.2 * diff(range(cc)),
           y = max(dd) - 0.08 * diff(range(dd)),
