...
if __name__ == "__main__":
    ...
    # Freeze / Unfreeze training settings
    Init_Epoch = 0
    Freeze_Epoch = 50
    Freeze_batch_size = 2
    UnFreeze_Epoch = 100
    ...
    model = PSPNet(
        ...
        downsample_factor=downsample_factor, pretrained=pretrained, aux_branch=aux_branch
    )
    if not pretrained:
        weights_init(model)
    if model_path != '':
    ...
    if local_rank == 0:
        ...
        # Warn if total training steps are insufficient
        ...
        if total_step <= wanted_step:
            ...
            print(f"[Warning] Total training steps {total_step} < recommended {wanted_step}. "
                  f"Consider setting total epochs to at least {wanted_epoch}.")
    ...
    if True:
        ...
        gen = DataLoader(
            ...
            pin_memory=True, drop_last=True, collate_fn=pspnet_dataset_collate,
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            fit_one_epoch(
                ...
                dice_loss, focal_loss, cls_weights, aux_branch, num_classes, fp16, scaler,
